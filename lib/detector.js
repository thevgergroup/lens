...
export function analyzePixelStatistics(imageData, isLossy = false) {
  ...
  // NOTE: Noise residual lag-1 autocorrelation and cross-channel noise correlation
  // were tested against the fixture set and found to be unreliable discriminators:
  // - Cross-channel correlation is high for BOTH real photos and AI images (scene lighting)
  // - Autocorrelation overlaps: real cloudscape JPEG scores 0.255, similar to some AI images
  // These signals are omitted to prevent false positives on real photographs.
